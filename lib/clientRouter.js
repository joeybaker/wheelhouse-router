...
module.exports = Backbone.Router.extend({
  initialize: function(options){
    ...
    if (!Backbone.History.started && Backbone.history.start(this.historyOptions)) this._started = true
  ...
  , _addRoutes: function(options){
    ...
    if (!Backbone.History.started) Backbone.history.start(this.historyOptions)
  }
