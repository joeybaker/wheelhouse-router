...
module.exports = Backbone.Router.extend({
  ...
  , start: function start(immediate){
    ...
    if (Backbone.History.started){
      // if we've already started, but haven't parsed our routes yet, check to see if any of the newly added routes match the current URL
      // The fragment can be a null string so that must be checked for.
      if (!this._started && Backbone.history.fragment !== '' && !Backbone.history.fragment){
