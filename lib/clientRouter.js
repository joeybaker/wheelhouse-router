...
router._setCollection = function(collectionName, collectionData, options){
  ...
  if (this.options.app.Datas[collectionName])
    ...
    this.options.app.Datas[collectionName] = new this.options.app.Collections[collectionName](_.isArray(collectionData) ? collectionData : !collectionData ? [] : [collectionData] , options)
