...
exports.attach = function(opts){
  ...
  options = _.extend(opts, {
    mutualRoutes: opts.mutualRoutes ? require(path.join(process.cwd(), opts.mutualRoutes)) : null
    , serverRoutes: opts.serverRoutes ? require(path.join(process.cwd(), opts.serverRoutes)) : null
    , collections: opts.collections ? path.join(process.cwd(), opts.collections) : null
    , controllers: opts.controllers ? path.join(process.cwd(), opts.controllers) : null
  })
